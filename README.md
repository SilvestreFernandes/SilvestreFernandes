...
🎓 Artificial Intelligence student at **CEUB** — Brasília, Brazil  
🤖 Passionate about Machine Learning, Automation, and Generative AI  
🐍 Building my skills in Python, one project at a time  
🚀 Goal: become an ML Engineer and work on impactful AI products  
...
### 🤖 [Claude Terminal Chat](https://github.com/SilvestreFernandes/chatbot-terminal)
A conversational AI chatbot that runs in your terminal, powered by the Anthropic Claude API.  
Multi-turn conversation, bilingual support (PT/EN), colorful terminal interface.

`Python` `Anthropic API` `CLI`
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=SilvestreFernandes&color=blue&style=flat-square&label=Profile+Views"/>
</p>